...
@Mod(CataInf.MODID)
public class CataInf
{
    // Define mod id in a common place for everything to reference
    public static final String MODID = "catainf";
    ...
    public CataInf(IEventBus modEventBus, ModContainer modContainer)
    {
